...
class PembayaranServiceController extends Controller
{
    ...
    {
        $pembayaran_service = PenerimaanService::with('kendaraan', 'customer_bengkel', 'detail_sparepart', 'detail_perbaikan','detail_sparepart.sparepart.jenissparepart.diskon', 'bengkel')->findOrFail($id_service_advisor);
